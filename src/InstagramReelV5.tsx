    ...
    <div style={{
      ...
      <AnimatedEntry delay={0}>
        <div style={{ marginBottom: 12 }}>
          <div style={{ color: theme.primary, fontSize: 10, fontWeight: 600, marginBottom: 2, fontFamily }}>📊 DASHBOARD</div>
          <div style={{ color: theme.text, fontSize: 18, fontWeight: 600, fontFamily }}>Your Business</div>
        </div>
      </AnimatedEntry>
          ...
          <AnimatedEntry key={i} delay={kpi.delay}>
            <Card>
              <CardContent style={{ padding: 10 }}>
                ...
                <div style={{ color: theme.dim, fontSize: 10, fontWeight: 400, fontFamily }}>{kpi.label}</div>
              </CardContent>
            </Card>
          </AnimatedEntry>
        ))}
      ...
      <AnimatedEntry delay={60}>
        <Card>
          <CardContent style={{ padding: 10 }}>
            <div style={{ color: theme.muted, fontSize: 10, marginBottom: 6, fontWeight: 500, fontFamily }}>Revenue Trend</div>
            <MiniChart delay={70} />
          </CardContent>
        </Card>
      </AnimatedEntry>
...
const MiniChart: React.FC<{ delay: number }> = ({ delay }) => {
  ...
  return (
    <svg width={w} height={h}>
      <defs>
        <linearGradient id="mg5" x1="0" y1="0" x2="0" y2="1">
      ...
      <g clipPath="url(#mc5)">
        <path d={`${path} L ${w} ${h} L 0 ${h} Z`} fill="url(#mg5)" />
...
const InvoiceScreen: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <AnimatedEntry delay={0}>
        <div style={{ marginBottom: 12 }}>
          <div style={{ color: theme.success, fontSize: 10, fontWeight: 600, marginBottom: 2, fontFamily }}>📄 INVOICES</div>
          <div style={{ color: theme.text, fontSize: 18, fontWeight: 600, fontFamily }}>Create in Seconds</div>
        </div>
      </AnimatedEntry>
          ...
          <CardContent style={{ padding: 14 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12, paddingBottom: 10, borderBottom: `1px solid ${theme.border}` }}>
              ...
              <div>
                ...
                <div style={{ color: theme.dim, fontSize: 10, fontWeight: 400, fontFamily }}>INV-2024-0048</div>
              </div>
            </div>
            ...
            {items.map((item, i) => {
              ...
              return (
                <div key={i} style={{
                  ...
                  <span style={{ color: theme.muted, fontSize: 12, fontWeight: 400, fontFamily }}>{item.name}</span>
            ...
            <div style={{
              ...
              <span style={{ color: theme.primary, fontSize: 20, fontWeight: 700, fontFamily }}>
...
const CopilotScreen: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      <AnimatedEntry delay={0}>
        <div style={{ marginBottom: 12 }}>
          <div style={{ color: '#8b5cf6', fontSize: 10, fontWeight: 600, marginBottom: 2, fontFamily }}>✨ AI COPILOT</div>
          <div style={{ color: theme.text, fontSize: 18, fontWeight: 600, fontFamily }}>Just Ask</div>
        </div>
      </AnimatedEntry>
          ...
          <div style={{
            ...
            {aiTyping ? (
              ...
              <div style={{ opacity: interpolate(frame - 75, [0, 12], [0, 1], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' }) }}>
                <span style={{ color: theme.text, fontSize: 12, fontWeight: 400, fontFamily }}>
                  Found <strong style={{ fontWeight: 600 }}>3</strong> = <strong style={{ color: theme.primary, fontWeight: 600 }}>AED 24,750</strong>
                </span>
              </div>
            )}
          </div>
...
// Main component
export const InstagramReelV5: React.FC = () => {
  return (
